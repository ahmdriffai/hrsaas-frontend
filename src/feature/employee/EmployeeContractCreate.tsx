...
export default function EmployeeContractCreate(): React.ReactNode {
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <div className=" py-3 flex flex-col justify-end w-full ">
          <div className="flex h-1 w-full justify-between gap-x-4">
            <ProgressBar currentStep={1} totalSteps={1} />
            <ProgressBar currentStep={0} totalSteps={3} />
          </div>
          <div className="flex justify-end bg-white px-6 py-5">
            {mutation.isPending ? (
